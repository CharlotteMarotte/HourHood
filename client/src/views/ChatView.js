        ...
        <div className="">
          ...
          <div className="flex flex-col relative md:gap-2 -top-6 md:-top-10">
            <h1 className="md:text-4xl text-lg text-[#FF9940]">
              {" "}
              <span className="md:text-5xl text-2xl text-[#361201] font-bold md:bg-[#ffe60099]">Chat </span>
                with your neighbours
            </h1>
            <h1 className="md:text-4xl text-lg text-[#FF9940]">
              About the{" "}
              <span className="md:text-5xl text-2xl text-[#361201] font-bold md:bg-[#c7e2429c]">details</span>
            </h1>
          </div>
        </div>
      </div>
