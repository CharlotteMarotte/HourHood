  ...
  return (
    <div className="min-h-screen px-16 py-8 min-w-screen">
      ...
      >
        ...
        />
        <circle cx="312.733" cy="273.513" r="57.048" fill="#ee781d" />
        <path
          fill="#e06714"
        ...
        />
        <circle cx="282.177" cy="274.625" r="8.829" fill="#f9ae2b" />
        <circle cx="341.279" cy="262.647" r="6.112" fill="#e06714" />
        <circle cx="307.149" cy="250.639" r="4.075" fill="#e06714" />
        <circle cx="308.658" cy="304.906" r="4.075" fill="#e06714" />
        <circle cx="332.207" cy="289.982" r="5.513" fill="#f9ae2b" />
        <circle cx="270.216" cy="326.179" r="3.132" fill="#3086a3" />
        <circle cx="372.913" cy="239.928" r="3.132" fill="#3086a3" />
        <path
          fill="#3086a3"
        ...
        <circle cx="144.12" cy="411.536" r="7.406" fill="#b9d4db" />
        <circle cx="126.92" cy="389.583" r="4.936" fill="#b9d4db" />
        <circle cx="115.301" cy="414.559" r="11.833" fill="#b9d4db" />
        <circle cx="308.282" cy="162.289" r="16.428" fill="#b9d4db" />
        <circle cx="275.694" cy="178.717" r="7.406" fill="#b9d4db" />
      ...
      <a
        href="https://iconscout.com/illustrations/page-not-found"
        target="_blank"
      >
